                    ...
                    {experience.map((job, index) => (
                        ...
                        >
                            ...
                            <div className={`md:flex items-start justify-between gap-10 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                                ...
                                {/* Date */}
                                <div className={`hidden md:block w-1/2 text-gray-400 font-mono text-sm ${index % 2 === 0 ? 'text-left' : 'text-right'} pt-1`}>
                                    {job.period}
                                </div>

                                {/* Mobile Date */}
                                <span className="md:hidden text-sm text-indigo-400 font-mono mb-2 block">{job.period}</span>
                                ...
                                <div className="md:w-1/2">
                                    <div className="glass-card p-6 md:p-8 hover:border-indigo-500/30">
                                        ...
                                        <div className="flex items-center gap-2 text-indigo-400 mb-4 font-medium">
                                            <Briefcase size={16} />
                        ...
                        {education.map((edu, index) => (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 mt-2 text-sm">{edu.school}</p>
                                    <span className="inline-block mt-2 text-xs font-mono text-indigo-300 bg-indigo-500/10 px-2 py-1 rounded">{edu.period}</span>
                                </div>
                            </motion.div>
                        ))}
                    </div>
